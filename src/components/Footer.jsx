...
import { logotipo, whatsappconfondo } from '../assets/indice'
...
export default function Footer() {
  return (
            ...
            <Link href={`https://wa.me/+5359106524?text=Hola%20Estrada!%20Necesitamos%20de%20sus%20servicios`} className=' pb-4'>
                <button type="button" className="text-white bg-[#5bd066] hover:bg-[#5bd066]/80 focus:ring-4 focus:outline-none focus:ring-[#5bd066]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center me-2 mb-2 mt-6">
                    <div className="w-4 h-4 me-2">
                        <Image src={whatsappconfondo} alt='logo-whatsapp'></Image>
                    </div>
        ...
        <div className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">  
            ...
            <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left md:mt-0 mt-10">
                <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
                    ...
                    <span className="ml-3 text-xl">Estrada Soluciones Electricas</span> */}
                    <div className='w-[40px]'>
                        <Image alt="logotipo" src={logotipo}/>
                    </div>
                </a>
                <p className="mt-2 text-sm text-gray-500">Transformando la energía en soluciones sostenibles</p>
            </div>
            ...
            <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                <h2 className="title-font font-medium text-gray-900 tracking-widest text-sm mb-3">PRODUCTOS</h2>
                <nav className="list-none mb-10">
                <li>
                    <a className="text-gray-600 hover:text-gray-800">First Link</a>
                </li>
    ...
    {/* licencia and social media */}
        <div className="bg-gray-100">
            <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
            <p className="text-gray-500 text-sm text-center sm:text-left">© 2023 Estrada Soluciones Electricas —
                <a href="https://twitter.com/knyttneve" rel="noopener noreferrer" className="text-gray-600 ml-1" target="_blank">estrada.soluciones.electricas@gmail.com</a>
            </p>
